    ...
    return (
      <div>
        ...
        <Form className="overlay">
          ...
          <FileUploader
            registeredZones={this.props.registeredZones}
            setZoneToRegister={this.props.setZoneToRegister}
            addPolygonToMap={this.addPolygonToMap}
          />
